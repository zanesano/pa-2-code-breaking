...
**NAMES:** Zane and Sequoia


```{r}
#| label: tidyverse
# comment: setting up tidy verse
library(tidyverse)
...
```{r}
#| label: my-symbols
# created a vector of the symbols, put them in the data frame, and assigned a number to each symbol
